...
\[
\operatorname{P}\bigl(L(x)\le F(x)\le U(x)\bigr)\ge 1-\alpha.
\]
...
На следующем рисунке приведены результаты, полученные с помощью \texttt{scipy.stats.ecdf}
