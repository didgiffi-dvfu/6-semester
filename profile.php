    ...
    if (!$title || !$main_text) {
        ...
        if (!empty($_FILES['file']['name'])) {
            ...
            if (
                ...
                /*
                 * Проверка только по Content-Type
                 * Можно тестировать через Burp Suite
                 */

                if (!in_array($_FILES['file']['type'], $allowedMimeTypes, true)) {

                    $error = 'Неверный MIME type';
        ...
        if ($error === '') {
            ...
            $usernameCookie = mysqli_real_escape_string(
                $link,
                $_COOKIE['User']
            );
            ...
            if ($imagePath !== '') {
                ...
                $sql = "
                    INSERT INTO posts
                    (username, title, main_text, image_path)
                    VALUES
                    ('$usernameCookie', '$titleSql', '$mainTextSql', '$imageSql')
                ";
                ...
                $sql = "
                    ...
                    (username, title, main_text, image_path)
                    VALUES
                    ('$usernameCookie', '$titleSql', '$mainTextSql', NULL)
                ";
            }
            ...
            <div class="post-card">
                ...
                <?php if (!empty($post['image_path'])): ?>
                    ...
                    <div class="post-img-container">
                        ...
                        <img
                            src="<?php echo htmlspecialchars($post['image_path'], ENT_QUOTES, 'UTF-8'); ?>"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="text-muted">
                        Пост #<?php echo (int)$post['id']; ?>
                    </span>

                    <a
                        href="/posts.php?id=<?php echo (int)$post['id']; ?>"
                        class="magic-link"
                    >
                        Открыть →
                    </a>
    ...
    <?php else: ?>
        ...
        <div class="post-card">
            ...
            <p class="text-muted mb-0">
                ...
                Создай первый пост через форму выше,
                и он сразу появится в профиле
